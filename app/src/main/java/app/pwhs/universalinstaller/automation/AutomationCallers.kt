...
object AutomationCallers {
    ...
    private fun signingSha256(context: Context, pkg: String): String? = runCatching {
        ...
        // `signingInfo` and GET_SIGNING_CERTIFICATES are API 28, and this app's minSdk is **24** —
        // lower than the reference's 26, so this branch covers more devices here, not fewer. On a
